...
# print("sea1 done.")
# run_sh_command("CUDA_VISIBLE_DEVICES=7 uv run main.py +alg=pqn_jaxtari_sea2_hier_baseline")
...
# print("k1 done.")
# run_sh_command("CUDA_VISIBLE_DEVICES=8 uv run main.py +alg=pqn_jaxtari_k2_hier_baseline")
...
# run_sh_command("CUDA_VISIBLE_DEVICES=10 uv run main.py +alg=pqn_jaxtari_breakout4_hier_comb")
...
# print("freeway3 done.")
# run_sh_command("CUDA_VISIBLE_DEVICES=9 uv run main.py +alg=pqn_jaxtari_freeway4_hier_comb")
# print("freeway4 done.") 
