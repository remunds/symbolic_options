...
# print("sea2 done.")
# run_sh_command("CUDA_VISIBLE_DEVICES=0 uv run main.py +alg=pqn_jaxtari_k2_hier_noisy0")
# run_sh_command("CUDA_VISIBLE_DEVICES=0 uv run main.py +alg=pqn_jaxtari_k2_hier_noisy1")
# print("k2 done.")
...
print("sea4 done.")
run_sh_command("CUDA_VISIBLE_DEVICES=3 uv run main.py +alg=pqn_jaxtari_k4_hier_comb_noisy0")
run_sh_command("CUDA_VISIBLE_DEVICES=3 uv run main.py +alg=pqn_jaxtari_k4_hier_comb_noisy1")
print("k4 done.")