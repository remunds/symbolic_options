...
# ----------------------------------------- JAXATARI
register(
    id='Jax-Seaquest-RM1-v0',
    entry_point='envs.jaxatari_rm.seaquest_environment:JaxSeaquestRMEnv1',
    max_episode_steps=20000,
)

register(
    id='Jax-Seaquest-RM2-v0',
    entry_point='envs.jaxatari_rm.seaquest_environment:JaxSeaquestRMEnv2',
    max_episode_steps=20000,
)

register(
    id='Jax-Kangaroo-RM1-v0',
    entry_point='envs.jaxatari_rm.kangaroo_environment:JaxKangarooRMEnv1',
    max_episode_steps=20000,
)

register(
    id='Jax-Kangaroo-RM2-v0',
    entry_point='envs.jaxatari_rm.kangaroo_environment:JaxKangarooRMEnv2',
    max_episode_steps=20000,
)
